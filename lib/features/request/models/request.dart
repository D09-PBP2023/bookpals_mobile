...
final requestStatusValues = EnumValues(
    {"APPROVED": RequestStatus.APPROVED, "REJECTED": RequestStatus.REJECTED});

enum Model { BOOK_REQUEST_REQUESTBOOK }

final modelValues =
    EnumValues({"book_request.requestbook": Model.BOOK_REQUEST_REQUESTBOOK});
