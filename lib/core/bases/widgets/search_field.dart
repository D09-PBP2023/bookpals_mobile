...
class BookpalsSearchField extends StatefulWidget {
  final String title;
  final String hint;
  ...
  @override
  State<BookpalsSearchField> createState() => _BpSearchFieldState();
}

class _BpSearchFieldState extends State<BookpalsSearchField> {
